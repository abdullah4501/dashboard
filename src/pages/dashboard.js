 ...
 * Straight line area chart + more dramatic dips in the data.
 */
...
const mainChartOptions = {
  ...
  // Straight lines (or "curve: 'straight'" if you want no smoothing at all)
  stroke: {
    curve: "smooth",
    width: 3,
  },
  ...
  return (
    <Layout>
      ...
      <div className="flex items-center space-x-4 mb-6 overflow-x-auto">
        {/* Make sure these buttons remain scrollable on small screens */}
        <button className="px-4 py-2 rounded-full text-[#FBB040] font-medium text-[18px] whitespace-nowrap">
          Today sales
        </button>
        <button className="px-4 py-2 rounded-full text-gray-600 font-medium text-[18px] hover:bg-gray-200 transition whitespace-nowrap">
      ...
      <div className="bg-white rounded-xl shadow p-6">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
          ...
          <button className="flex items-center bg-gray-100 text-gray-600 px-4 py-2 rounded-full hover:bg-gray-200 transition mt-2 md:mt-0">
            This month
            <FiCalendar className="ml-2" />
          </button>
        </div>

        {/* ApexChart: straight line area chart */}
        <ApexChart
